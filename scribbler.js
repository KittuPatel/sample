...
if (document.getElementsByClassName('details').length > 0) {
  var i = 0;
  var txt = `
  I'm a Front-End Developer based in Hyderabad, India 🇮🇳
  ...
  // Name: Krishna Sai Mangalarapu
  //Age: 20 Years old
  //Address: Hyderabad, Telangana 🇮🇳
  //Phone: +91 9640897033
  // Email: krish@mangalarapu.co

  function typeItOut () {
    if (i < txt.length) {
      document.getElementsByClassName('details')[0].innerHTML += txt.charAt(i);
      i++;
